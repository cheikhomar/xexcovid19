package io.bluetrace.xexcovid.services
...
import io.bluetrace.xexcovid.bluetooth.BLEAdvertiser
import io.bluetrace.xexcovid.bluetooth.gatt.ACTION_RECEIVED_STATUS
import io.bluetrace.xexcovid.bluetooth.gatt.ACTION_RECEIVED_STREETPASS
import io.bluetrace.xexcovid.bluetooth.gatt.STATUS
import io.bluetrace.xexcovid.bluetooth.gatt.STREET_PASS
import io.bluetrace.xexcovid.idmanager.TempIDManager
import io.bluetrace.xexcovid.idmanager.TemporaryID
import io.bluetrace.xexcovid.logging.CentralLog
import io.bluetrace.xexcovid.notifications.NotificationTemplates
import io.bluetrace.xexcovid.permissions.RequestFileWritePermission
import io.bluetrace.xexcovid.status.Status
import io.bluetrace.xexcovid.status.persistence.StatusRecord
import io.bluetrace.xexcovid.status.persistence.StatusRecordStorage
import io.bluetrace.xexcovid.streetpass.ConnectionRecord
import io.bluetrace.xexcovid.streetpass.StreetPassScanner
import io.bluetrace.xexcovid.streetpass.StreetPassServer
import io.bluetrace.xexcovid.streetpass.StreetPassWorker
import io.bluetrace.xexcovid.streetpass.persistence.StreetPassRecord
import io.bluetrace.xexcovid.streetpass.persistence.StreetPassRecordStorage
